            ...
            <Center>
              <Stack>
                <Title order={1} align="center" mb="lg" color="white">
                  Edit Your Property Today
                </Title>
                <Title order={4} align="center" mb="lg" color="white">
                  House No or Title
                </Title>
              </Stack>
            </Center>
          ...
          <Paper my="xl" p="sm" shadow="xl" radius="lg">
            <Grid>
              ...
              <Grid.Col xs={8}>
                <Grid>
                  <Grid.Col md={6}>
                    <Select disabled label="Category" value={cat} onChange={value => setCat(value)} data={[
                  ...
                  <Grid.Col md={6}>
                      <TextInput disabled label={cat === "building" ? "Size (Square Metres)" : "Size (Acres)"} />
                  </Grid.Col>
                  <Grid.Col md={6}>
                      <TextInput disabled label={cat === "building" ? "House Number" : "Title Deed"} />
                  </Grid.Col>
                  <Grid.Col md={6}>
                  ...
                  <Grid.Col md={6}>
                      <NumberInput disabled label="Location Latitude" />
                  </Grid.Col>
                  <Grid.Col md={6}>
                      <NumberInput disabled label="Location Longitue" />
                  </Grid.Col>
                </Grid>
              </Grid.Col>
              <Grid.Col span="auto"></Grid.Col>
